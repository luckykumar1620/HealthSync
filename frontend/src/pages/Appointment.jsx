...
const Appointment = () => {
 ...
 const getAvailableSlots = () => {
  ...
  let today = new Date();
  let finalSlots = []; // all days slots yaha collect karenge
  ...
  for (let i = 0; i < 7; i++) {
    ...
    while (currentDate < endTime) {
      ...
      let month = currentDate.getMonth() + 1; // ✅ yaha +1 kiya
  ...
  setDocSlots(finalSlots); // ✅ ek hi baar state update
};
  ...
  return docInfo && (
    <div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        <p>Booking Slots</p>
          <div className='flex gap-3 items-center w-full overflow-x-scroll-scroll mt-4'>
            {
       ...
       <button onClick={bookAppointment} className='bg-blue-500 text-white font-light px-14 py-3 rounded-full my-6'>Book an appointment</button>
      </div>
